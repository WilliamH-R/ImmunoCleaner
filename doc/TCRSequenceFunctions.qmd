...
The first function takes the raw data frame as input, and simply removes the unnecessary columns as these arent needed. By default, the columns removed are those containing `"_binder"` and the column `"cell_clono_cdr3_nt"`. The dimensions of the data sets are then changed as shown in @tbl-function_one_dim.
